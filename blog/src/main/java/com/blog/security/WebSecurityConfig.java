...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .cors().and()
                .authorizeRequests()
                .antMatchers("/", "/getPost/**", "/getPosts/**", "/upvotePost/**","/editPost/**", "/downvotePost/**", "/getComments/**", "/getComment/**", "/upvoteComment/**", "/downvoteComment/**","/createComment/**", "/createPost/**","/getUser/**").permitAll()
